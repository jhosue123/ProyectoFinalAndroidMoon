...
class CombosActivity : AppCompatActivity() {
    ...
    lateinit var service: ServiceCombos
    lateinit var recyclercombos: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        service = retrofit.create<ServiceCombos>(ServiceCombos::class.java)
        obtenerDataApiRest()
    ...
    private fun obtenerDataApiRest() {
        service.getAllProductos().enqueue(object : Callback<List<ProductoModel>> {
            override fun onResponse(call: Call<List<ProductoModel>>, response: Response<List<ProductoModel>>) {
                ...
                recyclercombos.adapter = AdapterAccesorios(acces!!)
            }
